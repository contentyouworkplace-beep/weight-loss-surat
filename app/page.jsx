  ...
  return (
    <div style={{minHeight:"100vh",background:"#0a1628",color:"#fff",fontFamily:"system-ui,sans-serif",padding:"2rem"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:"1rem"}}>
        {filtered.map(slug=>(
          <a key={slug} href={`/${slug}`} target="_blank"
            style={{background:"#111d2e",border:"1px solid #1e3a5f",borderRadius:12,padding:"1rem 1.25rem",textDecoration:"none",color:"#fff",display:"block"}}>
