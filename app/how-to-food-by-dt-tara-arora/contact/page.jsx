...
const P = { primary:"#6B1D1D", accent:"#D4A843", bg:"#FDF8F0", dark:"#3d0e0e" }
const PHONE = "919662739406"
const WA = "https://wa.me/919662739406?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services."
const PHDISP = "096627 39406"
...
export default function ContactPage() {
  ...
  const handleSubmit = e => {
    e.preventDefault()
    const msg = encodeURIComponent(`Hello How to Food by Dt. Tara Arora!\nName: ${form.name}\nPhone: ${form.phone}\n${form.message}`)
    window.open(`https://wa.me/919662739406?text=${msg}`, "_blank")
    setSent(true)
  }
        ...
        <div className="form-map-grid" style={{maxWidth:1100,margin:"0 auto"}}>
          <div>
            ...
            {sent ? (
              <div style={{background:"#e8f5e9",borderRadius:12,padding:"2rem",textAlign:"center"}}>
                ...
                <button onClick={()=>setSent(false)} style={{marginTop:"1rem",padding:"0.6rem 1.5rem",borderRadius:8,background:"#6B1D1D",color:"#fff",border:"none",cursor:"pointer"}}>Send Another</button>
              </div>
            ) : (
              <form onSubmit={handleSubmit} style={{display:"flex",flexDirection:"column",gap:"1rem"}}>
                ...
                <a href="tel:919662739406" style={{display:"block",padding:"0.85rem",borderRadius:10,background:"#6B1D1D",color:"#fff",fontWeight:700,fontSize:16,textDecoration:"none",textAlign:"center"}}>📞 Call: 096627 39406</a>
              </form>
            )}
          ...
          <div>
            ...
            <div style={{borderRadius:16,overflow:"hidden",boxShadow:"0 4px 24px rgba(0,0,0,0.1)",marginBottom:"1rem"}}>
              <iframe src="https://maps.google.com/maps?q=How+to+Food+by+Dt.+Tara+Arora+google&output=embed" width="100%" height="350" style={{border:0,display:"block"}} allowFullScreen referrerPolicy="no-referrer-when-downgrade" loading="lazy" title="Location"/>
            </div>
            <div style={{padding:"1rem",background:"#fff",borderRadius:12,border:"1px solid #e8e0d5"}}>
              <div style={{fontSize:15,fontWeight:600,color:P.dark,marginBottom:4}}>📍 How to Food by Dt. Tara Arora</div>
              <div style={{fontSize:14,color:"#666"}}>Surat, Gujarat, India</div>
              <div style={{marginTop:8,display:"flex",gap:"0.75rem",flexWrap:"wrap"}}>
                <a href="tel:919662739406" style={{color:"#6B1D1D",fontWeight:600,fontSize:14}}>📞 096627 39406</a>
                <a href="https://wa.me/919662739406?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#25D366",fontWeight:600,fontSize:14}}>💬 WhatsApp</a>
              </div>
            </div>
          </div>
        </div>
