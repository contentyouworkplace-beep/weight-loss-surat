...
export default function GalleryPage() {
    ...
    <div style={{maxWidth:"1200px",margin:"0 auto"}}>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1506629082955-511b1aa562c8?w=1200&q=80" alt="Transformation 1" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
      ...
      <div key="1" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1455853659719-4b521eebc76d?w=1200&q=80" alt="Transformation 2" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#4A7C59",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="2" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=1200&q=80" alt="Transformation 3" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#4A7C59",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="3" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=600&q=80" alt="Transformation 4" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#4A7C59",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="4" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=600&q=80" alt="Transformation 5" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#4A7C59",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="5" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=600&q=80" alt="Transformation 6" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#4A7C59",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
  ...
  <section style={{background:"#fff",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <p style={{color:"#666",marginBottom:"2rem",fontSize:"1.1rem",maxWidth:"500px",margin:"0 auto 2rem"}}>Join Biofit Chiropractic Physiotherapy Fitness Studio and become our next transformation story.</p>
    <a href="https://wa.me/918866460517?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#4A7C59",color:"#fff",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>Start Your Journey →</a>
  </section>
