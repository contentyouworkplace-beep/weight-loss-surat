...
export default function AboutPage() {
  ...
  <section style={{background:"linear-gradient(135deg,#e3f4e8,#a5d6a7)",padding:"4rem 2rem",textAlign:"center"}}>
    <h1 style={{fontSize:"clamp(2rem,4vw,3rem)",fontWeight:800,color:"#2D4F38",marginBottom:"0.7rem"}}>About <span style={{color:"#4A7C59"}}>Biofit Chiropractic Physiotherapy Fitness Studio</span></h1>
  ...
  <section style={{background:"#F5FAF6",padding:"5rem 2rem"}}>
    <div className="grid-2" style={{maxWidth:"1100px",margin:"0 auto",gap:"3rem",alignItems:"center"}}>
      <div style={{display:"flex",flexDirection:"column",gap:"1.2rem"}}>
        <h2 style={{fontSize:"1.8rem",fontWeight:800,color:"#2D4F38",margin:0}}>Our Story</h2>
        <p style={{color:"#555",lineHeight:1.8,margin:0}}>Founded with a simple belief — <strong>every person deserves to feel their best</strong>. Biofit Chiropractic Physiotherapy Fitness Studio was born out of a passion for helping people in google break free from fad diets and unsustainable habits.</p>
        ...
        <a href="https://wa.me/918866460517?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{display:"inline-block",background:"#4A7C59",color:"#fff",padding:"0.85rem 2rem",borderRadius:"8px",textDecoration:"none",fontWeight:700,width:"fit-content"}}>Book a Free Consult</a>
      </div>
      <div style={{borderRadius:"16px",overflow:"hidden",boxShadow:"0 8px 32px rgba(0,0,0,0.12)"}}>
        <img src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?w=800&q=80" alt="About Biofit Chiropractic Physiotherapy Fitness Studio" style={{width:"100%",height:"360px",objectFit:"cover",display:"block"}} loading="lazy" />
      </div>
    </div>
  </section>
  ...
  <section style={{background:"#fff",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1000px",margin:"0 auto"}}>
      <h2 style={{textAlign:"center",fontSize:"1.8rem",fontWeight:800,color:"#2D4F38",marginBottom:"2.5rem"}}>Our Core Values</h2>
      <div className="grid-2" style={{gap:"2rem"}}>
        <div key="0" style={{display:"flex",gap:"1rem",alignItems:"flex-start"}}>
          <span style={{fontSize:"2rem",flexShrink:0}}>🧬</span>
          <div>
            <h4 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:700}}>Science-First</h4>
        ...
        <div key="1" style={{display:"flex",gap:"1rem",alignItems:"flex-start"}}>
          <span style={{fontSize:"2rem",flexShrink:0}}>🤝</span>
          <div>
            <h4 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:700}}>Personalised Care</h4>
        ...
        <div key="2" style={{display:"flex",gap:"1rem",alignItems:"flex-start"}}>
          <span style={{fontSize:"2rem",flexShrink:0}}>💚</span>
          <div>
            <h4 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:700}}>Holistic Approach</h4>
        ...
        <div key="3" style={{display:"flex",gap:"1rem",alignItems:"flex-start"}}>
          <span style={{fontSize:"2rem",flexShrink:0}}>📈</span>
          <div>
            <h4 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:700}}>Proven Results</h4>
  ...
  <section style={{background:"#F5FAF6",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      <h2 style={{textAlign:"center",fontSize:"1.8rem",fontWeight:800,color:"#2D4F38",marginBottom:"2.5rem"}}>Meet Our Expert Team</h2>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.08)",textAlign:"center"}}>
        ...
        <div style={{padding:"1.4rem"}}>
          <h3 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:800}}>Dr. Anjali Mehta</h3>
          <div style={{color:"#4A7C59",fontWeight:700,fontSize:"0.9rem",marginBottom:"0.5rem"}}>Head Nutritionist & Founder</div>
      ...
      <div key="1" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.08)",textAlign:"center"}}>
        ...
        <div style={{padding:"1.4rem"}}>
          <h3 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:800}}>Ravi Sharma</h3>
          <div style={{color:"#4A7C59",fontWeight:700,fontSize:"0.9rem",marginBottom:"0.5rem"}}>Fitness & Wellness Coach</div>
      ...
      <div key="2" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.08)",textAlign:"center"}}>
        ...
        <div style={{padding:"1.4rem"}}>
          <h3 style={{margin:"0 0 0.3rem",color:"#2D4F38",fontWeight:800}}>Pooja Desai</h3>
          <div style={{color:"#4A7C59",fontWeight:700,fontSize:"0.9rem",marginBottom:"0.5rem"}}>Holistic Health Advisor</div>
  ...
  <section style={{background:"linear-gradient(135deg,#4A7C59,#2D4F38)",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <p style={{color:"#ffffffcc",marginBottom:"2rem",fontSize:"1.1rem"}}>Your first consultation at Biofit Chiropractic Physiotherapy Fitness Studio is completely FREE.</p>
    <a href="https://wa.me/918866460517?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#fff",color:"#4A7C59",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>Get Started Today →</a>
  </section>
