...
export const metadata = {
  title: 'Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist | Surat',
  description: 'Top weight loss & wellness centre in Surat. Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist offers expert diet plans, nutrition coaching, and body transformation programs.',
}
      ...
      <style>{`
        ...
        <footer style={{background:P.dark, color:"#ccc", padding:"2rem 1.5rem", marginTop:"2rem"}}>
          <div style={{maxWidth:1100, margin:"0 auto", display:"flex", justifyContent:"space-between", flexWrap:"wrap", gap:"1rem"}}>
            <div>
              <div style={{fontFamily:"'Cormorant Garamond',serif", fontSize:20, color:"#fff", marginBottom:6}}>Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist</div>
          ...
          <div style={{textAlign:"center", fontSize:12, marginTop:"1.5rem", borderTop:"1px solid rgba(255,255,255,0.1)", paddingTop:"1rem", color:"#888"}}>
            © 2025 Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist. All rights reserved.
          </div>
        </footer>
