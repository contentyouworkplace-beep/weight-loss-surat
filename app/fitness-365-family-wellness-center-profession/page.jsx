...
export default function HomePage() {
  ...
  <section style={{background:"linear-gradient(135deg,#ffe4ec 0%,#FFF5F7 100%)",padding:"5rem 0 4rem"}}>
    <div className="hero-grid" style={{maxWidth:"1200px",margin:"0 auto",padding:"0 2rem",gap:"3rem",alignItems:"center"}}>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:"1.4rem"}}>
        ...
        <p style={{color:"#555",fontSize:"1.05rem",lineHeight:1.75,margin:0}}>At <strong>Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist</strong> in google, we combine science-backed nutrition with personalised coaching to help you achieve lasting results.</p>
        <div style={{borderRadius:"14px",overflow:"hidden",boxShadow:"0 8px 32px rgba(0,0,0,0.12)",maxWidth:"420px"}}>
          <img src="https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=1200&q=80" alt="Wellness at Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist" style={{width:"100%",height:"240px",objectFit:"cover",display:"block"}} loading="eager" />
        </div>
        <div style={{display:"flex",gap:"0.8rem",flexWrap:"wrap"}}>
          <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#C2687C",color:"#fff",padding:"0.85rem 1.8rem",borderRadius:"8px",textDecoration:"none",fontWeight:700}}>WhatsApp Us 💬</a>
          <a href="tel:+919825287210" style={{border:"2px solid #C2687C",color:"#C2687C",padding:"0.85rem 1.8rem",borderRadius:"8px",textDecoration:"none",fontWeight:700}}>Call Now</a>
        </div>
      </div>
      {/* RIGHT: form */}
      <div style={{background:"#fff",borderRadius:"16px",padding:"2.5rem",boxShadow:"0 8px 40px rgba(0,0,0,0.12)"}}>
        ...
        <p style={{margin:"1rem 0 0",textAlign:"center",fontSize:"0.85rem",color:"#999"}}>📞 098252 87210 | 🔒 100% Private</p>
      </div>
    </div>
  </section>
    ...
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      <div className="grid-2" style={{alignItems:"center",gap:"4rem"}}>
        ...
        <div>
          ...
          <h2 style={{fontSize:"clamp(1.8rem,3.5vw,2.5rem)",fontWeight:800,color:"#8B3A4A",marginBottom:"1.2rem",margin:"0 0 1.2rem"}}>The Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist Difference</h2>
          ...
          <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"inline-block",background:"#C2687C",color:"#fff",padding:"0.85rem 2rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Book Free Consultation →</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style={{background:"#FFF5F7",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1200px",margin:"0 auto"}}>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"12px",padding:"1.8rem",boxShadow:"0 2px 16px rgba(0,0,0,0.07)",transition:"transform 0.2s",display:"flex",flexDirection:"column",gap:"0.7rem"}}>
        ...
        <a href="/fitness-365-family-wellness-center-profession/services" style={{color:"#C2687C",fontWeight:700,textDecoration:"none",fontSize:"0.9rem"}}>Learn more →</a>
      </div>
  ...
  <section style={{background:"#f9f9f9",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"12px",padding:"1.8rem",boxShadow:"0 2px 16px rgba(0,0,0,0.07)"}}>
        <p style={{margin:"0 0 1rem",color:"#444",lineHeight:1.7,fontStyle:"italic"}}>"Lost 14 kg in 3 months! The team at Fitness 365 ( Family Wellness Center) Professional Nutririonist / Weight loss Specialist is incredible."</p>
      ...
      <p style={{textAlign:"center",marginTop:"2rem"}}>
        <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#C2687C",fontWeight:700,textDecoration:"none",borderBottom:"2px solid #C2687C",paddingBottom:"2px"}}>Read More Reviews on Google →</a>
      </p>
    </div>
  </section>
    ...
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      ...
      <div className="pricing-grid">
        <div style={{background:"#fff",borderRadius:"16px",padding:"2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.07)",textAlign:"center"}}>
          ...
          <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",border:"2px solid #C2687C",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Get Started</a>
        </div>
        <div style={{background:"#C2687C",borderRadius:"16px",padding:"2rem",boxShadow:"0 8px 32px #C2687C44",textAlign:"center",position:"relative",transform:"scale(1.04)"}}>
          ...
          <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",background:"#fff",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:800,textDecoration:"none"}}>Choose Transform</a>
        </div>
        <div style={{background:"#fff",borderRadius:"16px",padding:"2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.07)",textAlign:"center"}}>
          ...
          <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",border:"2px solid #C2687C",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Go Platinum</a>
        </div>
      </div>
      <p style={{textAlign:"center",marginTop:"1.5rem",color:"#888",fontSize:"0.9rem"}}>💬 Need a custom package? <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#C2687C",fontWeight:700}}>Chat with us on WhatsApp</a></p>
    </div>
  </section>
      ...
      <div className="grid-3">
        <div style={{background:"#FFF5F7",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 16px rgba(0,0,0,0.07)"}}>
          ...
          <div style={{padding:"1.4rem"}}>
            ...
            <a href="/fitness-365-family-wellness-center-profession/services" style={{color:"#C2687C",fontWeight:700,fontSize:"0.9rem"}}>Read More →</a>
          </div>
        </div>
        <div style={{background:"#FFF5F7",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 16px rgba(0,0,0,0.07)"}}>
  ...
  <section style={{background:"#fff",padding:"4rem 2rem"}}>
    <div style={{maxWidth:"1000px",margin:"0 auto"}}>
      ...
      <iframe src="https://maps.google.com/maps?q=Fitness+365+(+Family+Wellness+Center)+Professional+Nutririonist+/+Weight+loss+Specialist+google&output=embed" width="100%" height="350" style={{border:0,borderRadius:"12px",boxShadow:"0 4px 20px rgba(0,0,0,0.1)"}} allowFullScreen loading="lazy"></iframe>
      <div className="grid-3" style={{marginTop:"1.5rem",gap:"1rem",textAlign:"center"}}>
        ...
        <div style={{padding:"1rem",background:"#FFF5F7",borderRadius:"10px"}}><div style={{fontSize:"1.5rem"}}>📞</div><a href="tel:+919825287210" style={{fontWeight:600,color:"#C2687C",textDecoration:"none",display:"block",marginTop:"0.4rem"}}>098252 87210</a></div>
  ...
  <section style={{background:"linear-gradient(135deg,#C2687C,#8B3A4A)",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <div style={{display:"flex",gap:"1rem",justifyContent:"center",flexWrap:"wrap"}}>
      <a href="https://wa.me/919825287210?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#fff",color:"#C2687C",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>WhatsApp Now 💬</a>
      <a href="tel:+919825287210" style={{border:"2px solid #fff",color:"#fff",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>📞 098252 87210</a>
    </div>
  </section>
