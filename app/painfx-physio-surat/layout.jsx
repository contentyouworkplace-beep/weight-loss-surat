...
export const metadata = {
  title: 'PAINFX PHYSIO SURAT | Surat',
  description: 'Top weight loss & wellness centre in Surat. PAINFX PHYSIO SURAT offers expert diet plans, nutrition coaching, and body transformation programs.',
}
      ...
      <style>{`
        ...
        <footer style={{background:P.dark, color:"#ccc", padding:"2rem 1.5rem", marginTop:"2rem"}}>
          <div style={{maxWidth:1100, margin:"0 auto", display:"flex", justifyContent:"space-between", flexWrap:"wrap", gap:"1rem"}}>
            <div>
              <div style={{fontFamily:"'Cormorant Garamond',serif", fontSize:20, color:"#fff", marginBottom:6}}>PAINFX PHYSIO SURAT</div>
          ...
          <div style={{textAlign:"center", fontSize:12, marginTop:"1.5rem", borderTop:"1px solid rgba(255,255,255,0.1)", paddingTop:"1rem", color:"#888"}}>
            © 2025 PAINFX PHYSIO SURAT. All rights reserved.
          </div>
        </footer>
