...
const PHONE = "919586145296"
const WA = "https://wa.me/919586145296?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services."
const PHDISP = "095861 45296"
...
export default function ContactPage() {
  ...
  const handleSubmit = e => {
    e.preventDefault()
    const msg = encodeURIComponent(`Hello SLIMIPHY FITNESS CENTER- VESU BRANCH (AUTOMATIC GYM)!\nName: ${form.name}\nPhone: ${form.phone}\n${form.message}`)
    window.open(`https://wa.me/919586145296?text=${msg}`, "_blank")
    setSent(true)
  }
        ...
        <div className="form-map-grid" style={{maxWidth:1100,margin:"0 auto"}}>
          <div>
            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} style={{display:"flex",flexDirection:"column",gap:"1rem"}}>
                ...
                <a href="tel:919586145296" style={{display:"block",padding:"0.85rem",borderRadius:10,background:"#0D6B6B",color:"#fff",fontWeight:700,fontSize:16,textDecoration:"none",textAlign:"center"}}>📞 Call: 095861 45296</a>
              </form>
            )}
          ...
          <div>
            ...
            <div style={{borderRadius:16,overflow:"hidden",boxShadow:"0 4px 24px rgba(0,0,0,0.1)",marginBottom:"1rem"}}>
              <iframe src="https://maps.google.com/maps?q=SLIMIPHY+FITNESS+CENTER-+VESU+BRANCH+(AUTOMATIC+GYM)+google&output=embed" width="100%" height="350" style={{border:0,display:"block"}} allowFullScreen referrerPolicy="no-referrer-when-downgrade" loading="lazy" title="Location"/>
            </div>
            <div style={{padding:"1rem",background:"#fff",borderRadius:12,border:"1px solid #e8e0d5"}}>
              <div style={{fontSize:15,fontWeight:600,color:P.dark,marginBottom:4}}>📍 SLIMIPHY FITNESS CENTER- VESU BRANCH (AUTOMATIC GYM)</div>
              <div style={{fontSize:14,color:"#666"}}>Surat, Gujarat, India</div>
              <div style={{marginTop:8,display:"flex",gap:"0.75rem",flexWrap:"wrap"}}>
                <a href="tel:919586145296" style={{color:"#0D6B6B",fontWeight:600,fontSize:14}}>📞 095861 45296</a>
                <a href="https://wa.me/919586145296?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#25D366",fontWeight:600,fontSize:14}}>💬 WhatsApp</a>
              </div>
            </div>
          </div>
        </div>
