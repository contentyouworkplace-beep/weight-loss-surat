...
export default function AboutPage() {
  ...
  <section style={{background:"linear-gradient(135deg,#e8f8ee,#b7e4c7)",padding:"4rem 2rem",textAlign:"center"}}>
    <h1 style={{fontSize:"clamp(2rem,4vw,3rem)",fontWeight:800,color:"#1B5E35",marginBottom:"0.7rem"}}>About <span style={{color:"#2E8B57"}}>Slimfit weight loss & wellness centre</span></h1>
  ...
  <section style={{background:"#F5FDF8",padding:"5rem 2rem"}}>
    <div className="grid-2" style={{maxWidth:"1100px",margin:"0 auto",gap:"3rem",alignItems:"center"}}>
      <div style={{display:"flex",flexDirection:"column",gap:"1.2rem"}}>
        ...
        <p style={{color:"#555",lineHeight:1.8,margin:0}}>Founded with a simple belief — <strong>every person deserves to feel their best</strong>. Slimfit weight loss & wellness centre was born out of a passion for helping people in google break free from fad diets and unsustainable habits.</p>
  ...
  <section style={{background:"linear-gradient(135deg,#2E8B57,#1B5E35)",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <p style={{color:"#ffffffcc",marginBottom:"2rem",fontSize:"1.1rem"}}>Your first consultation at Slimfit weight loss & wellness centre is completely FREE.</p>
    <a href="https://wa.me/918849206154?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#fff",color:"#2E8B57",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>Get Started Today →</a>
  </section>
