...
export default function GalleryPage() {
  ...
  <section style={{background:"#F0FAF9",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1200px",margin:"0 auto"}}>
      ...
      <div key="1" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1583454110551-21f2fa2afe61?w=600&q=80" alt="Transformation 2" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#00897B",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="2" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&q=80" alt="Transformation 3" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#00897B",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="3" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=1200&q=80" alt="Transformation 4" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#00897B",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="4" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=1200&q=80" alt="Transformation 5" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#00897B",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
      ...
      <div key="5" style={{background:"#fff",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 20px rgba(0,0,0,0.09)",cursor:"pointer"}}>
        <div style={{position:"relative",overflow:"hidden"}}>
          <img src="https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=1200&q=80" alt="Transformation 6" style={{width:"100%",height:"240px",objectFit:"cover",display:"block",transition:"transform 0.3s"}} loading="lazy" />
          <div style={{position:"absolute",top:"0.8rem",right:"0.8rem",background:"#00897B",color:"#fff",padding:"3px 10px",borderRadius:"20px",fontSize:"0.75rem",fontWeight:700}}>REAL RESULT</div>
        </div>
        <div style={{padding:"1.2rem"}}>
  ...
  <section style={{background:"#fff",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <p style={{color:"#666",marginBottom:"2rem",fontSize:"1.1rem",maxWidth:"500px",margin:"0 auto 2rem"}}>Join Herbalife Nutrition Surat (Nutrizone 1..) and become our next transformation story.</p>
    <a href="https://wa.me/919662024993?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#00897B",color:"#fff",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>Start Your Journey →</a>
  </section>
