...
export default function HomePage() {
  ...
  <section style={{background:"linear-gradient(135deg,#ffe4ec 0%,#f48fb1 100%)",padding:"0"}}>
    <div className="hero-grid" style={{minHeight:"88vh",alignItems:"stretch"}}>
      ...
      <div style={{position:"relative",overflow:"hidden",minHeight:"88vh"}}>
        <img src="https://images.unsplash.com/photo-1498837167922-ddd27525d352?w=1200&q=80" alt="Vcare Physio Clinic - Surat / Oral Placement Therapy/ Dry Needling / Pediatric Therapy / Speech Clarity" style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}} loading="eager" />
      ...
      <div style={{display:"flex",flexDirection:"column",justifyContent:"center",padding:"3rem 2.5rem",gap:"1.5rem"}}>
        <div style={{display:"inline-block",background:"#C2687C22",color:"#C2687C",padding:"4px 14px",borderRadius:"20px",fontSize:"0.78rem",fontWeight:700,letterSpacing:"0.08em",width:"fit-content"}}>SURAT'S #1 WELLNESS CENTRE</div>
        <h1 style={{fontSize:"clamp(2rem,4vw,3rem)",fontWeight:800,color:"#8B3A4A",lineHeight:1.15,margin:0}}>Transform Your Body,<br/><span style={{color:"#C2687C"}}>Transform Your Life</span></h1>
        <p style={{color:"#555",fontSize:"1.1rem",lineHeight:1.7,margin:0}}>Expert nutrition coaching &amp; fitness programs tailored just for you. Join 500+ success stories at <strong>Vcare Physio Clinic - Surat / Oral Placement Therapy/ Dry Needling / Pediatric Therapy / Speech Clarity</strong>.</p>
        <div style={{display:"flex",gap:"0.8rem",flexWrap:"wrap"}}>
          <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#C2687C",color:"#fff",padding:"0.85rem 1.8rem",borderRadius:"8px",textDecoration:"none",fontWeight:700,fontSize:"1rem"}}>Book Free Consult 📞</a>
          <a href="/vcare-physio-clinic---surat-oral-placement-th/services" style={{border:"2px solid #C2687C",color:"#C2687C",padding:"0.85rem 1.8rem",borderRadius:"8px",textDecoration:"none",fontWeight:700,fontSize:"1rem"}}>Our Programs</a>
        </div>
        {/* Quick form */}
        <div style={{background:"#fff",borderRadius:"12px",padding:"1.5rem",boxShadow:"0 4px 24px rgba(0,0,0,0.10)",marginTop:"0.5rem"}}>
          <p style={{margin:"0 0 1rem",fontWeight:700,color:"#8B3A4A",fontSize:"1rem"}}>Get a FREE Consultation</p>
          <form action="https://formspree.io/f/placeholder" method="POST" style={{display:"flex",flexDirection:"column",gap:"0.7rem"}}>
            ...
            <button type="submit" style={{background:"#F7C59F",color:"#fff",border:"none",padding:"0.7rem",borderRadius:"6px",fontWeight:700,fontSize:"1rem",cursor:"pointer"}}>Send Request ✓</button>
          </form>
        </div>
      </div>
    </div>
    ...
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      <div className="grid-2" style={{alignItems:"center",gap:"4rem"}}>
        ...
        <div>
          ...
          <h2 style={{fontSize:"clamp(1.8rem,3.5vw,2.5rem)",fontWeight:800,color:"#8B3A4A",marginBottom:"1.2rem",margin:"0 0 1.2rem"}}>The Vcare Physio Clinic - Surat / Oral Placement Therapy/ Dry Needling / Pediatric Therapy / Speech Clarity Difference</h2>
          ...
          <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"inline-block",background:"#C2687C",color:"#fff",padding:"0.85rem 2rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Book Free Consultation →</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style={{background:"#FFF5F7",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1200px",margin:"0 auto"}}>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"12px",padding:"1.8rem",boxShadow:"0 2px 16px rgba(0,0,0,0.07)",transition:"transform 0.2s",display:"flex",flexDirection:"column",gap:"0.7rem"}}>
        ...
        <a href="/vcare-physio-clinic---surat-oral-placement-th/services" style={{color:"#C2687C",fontWeight:700,textDecoration:"none",fontSize:"0.9rem"}}>Learn more →</a>
      </div>
  ...
  <section style={{background:"#f9f9f9",padding:"5rem 2rem"}}>
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      ...
      <div key="0" style={{background:"#fff",borderRadius:"12px",padding:"1.8rem",boxShadow:"0 2px 16px rgba(0,0,0,0.07)"}}>
        <p style={{margin:"0 0 1rem",color:"#444",lineHeight:1.7,fontStyle:"italic"}}>"Lost 14 kg in 3 months! The team at Vcare Physio Clinic - Surat / Oral Placement Therapy/ Dry Needling / Pediatric Therapy / Speech Clarity is incredible."</p>
      ...
      <p style={{textAlign:"center",marginTop:"2rem"}}>
        <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#C2687C",fontWeight:700,textDecoration:"none",borderBottom:"2px solid #C2687C",paddingBottom:"2px"}}>Read More Reviews on Google →</a>
      </p>
    </div>
  </section>
    ...
    <div style={{maxWidth:"1100px",margin:"0 auto"}}>
      ...
      <div className="pricing-grid">
        <div style={{background:"#fff",borderRadius:"16px",padding:"2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.07)",textAlign:"center"}}>
          ...
          <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",border:"2px solid #C2687C",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Get Started</a>
        </div>
        <div style={{background:"#C2687C",borderRadius:"16px",padding:"2rem",boxShadow:"0 8px 32px #C2687C44",textAlign:"center",position:"relative",transform:"scale(1.04)"}}>
          ...
          <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",background:"#fff",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:800,textDecoration:"none"}}>Choose Transform</a>
        </div>
        <div style={{background:"#fff",borderRadius:"16px",padding:"2rem",boxShadow:"0 4px 20px rgba(0,0,0,0.07)",textAlign:"center"}}>
          ...
          <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{display:"block",border:"2px solid #C2687C",color:"#C2687C",padding:"0.75rem",borderRadius:"8px",fontWeight:700,textDecoration:"none"}}>Go Platinum</a>
        </div>
      </div>
      <p style={{textAlign:"center",marginTop:"1.5rem",color:"#888",fontSize:"0.9rem"}}>💬 Need a custom package? <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" style={{color:"#C2687C",fontWeight:700}}>Chat with us on WhatsApp</a></p>
    </div>
  </section>
      ...
      <div className="grid-3">
        <div style={{background:"#FFF5F7",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 16px rgba(0,0,0,0.07)"}}>
          ...
          <div style={{padding:"1.4rem"}}>
            ...
            <a href="/vcare-physio-clinic---surat-oral-placement-th/services" style={{color:"#C2687C",fontWeight:700,fontSize:"0.9rem"}}>Read More →</a>
          </div>
        </div>
        <div style={{background:"#FFF5F7",borderRadius:"14px",overflow:"hidden",boxShadow:"0 4px 16px rgba(0,0,0,0.07)"}}>
  ...
  <section style={{background:"#fff",padding:"4rem 2rem"}}>
    <div style={{maxWidth:"1000px",margin:"0 auto"}}>
      ...
      <iframe src="https://maps.google.com/maps?q=Vcare+Physio+Clinic+-+Surat+/+Oral+Placement+Therapy/+Dry+Needling+/+Pediatric+Therapy+/+Speech+Clarity+google&output=embed" width="100%" height="350" style={{border:0,borderRadius:"12px",boxShadow:"0 4px 20px rgba(0,0,0,0.1)"}} allowFullScreen loading="lazy"></iframe>
      <div className="grid-3" style={{marginTop:"1.5rem",gap:"1rem",textAlign:"center"}}>
        ...
        <div style={{padding:"1rem",background:"#FFF5F7",borderRadius:"10px"}}><div style={{fontSize:"1.5rem"}}>📞</div><a href="tel:+919725432772" style={{fontWeight:600,color:"#C2687C",textDecoration:"none",display:"block",marginTop:"0.4rem"}}>097254 32772</a></div>
  ...
  <section style={{background:"linear-gradient(135deg,#C2687C,#8B3A4A)",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <div style={{display:"flex",gap:"1rem",justifyContent:"center",flexWrap:"wrap"}}>
      <a href="https://wa.me/919725432772?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#fff",color:"#C2687C",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>WhatsApp Now 💬</a>
      <a href="tel:+919725432772" style={{border:"2px solid #fff",color:"#fff",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>📞 097254 32772</a>
    </div>
  </section>
