...
export default function GalleryPage() {
  ...
  <section style={{background:"#fff",padding:"5rem 2rem",textAlign:"center"}}>
    ...
    <p style={{color:"#666",marginBottom:"2rem",fontSize:"1.1rem",maxWidth:"500px",margin:"0 auto 2rem"}}>Join WELLNESS 24 and become our next transformation story.</p>
    <a href="https://wa.me/919904142813?text=Hi%2C%20I%20found%20you%20on%20Google%20and%20I%27m%20interested%20in%20your%20services." target="_blank" rel="noopener" style={{background:"#00897B",color:"#fff",padding:"1rem 2.5rem",borderRadius:"8px",textDecoration:"none",fontWeight:800,fontSize:"1.05rem"}}>Start Your Journey →</a>
  </section>
